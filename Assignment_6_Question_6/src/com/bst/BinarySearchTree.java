...
public class BinarySearchTree {
	...
	public List<String> getChildren(int key) {
		Node trav = root;
		
		while(trav!=null) {
			if(trav.data == key) {
				List<String> childrenList =  new ArrayList<String>() {};
				childrenList.add(trav.left==null?null:Integer.toString(trav.left.data));
				childrenList.add(trav.right==null?null:Integer.toString(trav.right.data));
				return childrenList;
			}
